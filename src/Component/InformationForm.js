...
class InformationForm extends React.Component{
    handlesubmit = (e) => {
        ...
        const nation = this.getNationality.value;
        const citizenid = this.getCitizenID.value;
        const gender = this.getGender;
        const mobileno = this.getMobileNo;
    ...
    CheckLength(e){
        ...
        if(num.length > 13)
        {
            alert("Must be 13 digits!!");
            e.target.message = 'Test';
        }
        console.log(num);
    }
    ...
    render(){
        return(
            ...
            <div className='container container-style' id='info-form'>
                ...
                <div className='row' id = 'row1'>
                    <div className = 'col-sm-2'>
                        <div className="form-group row">
                            ...
                            <div className="col-md-9">
                                <select required className = 'form-control font-style' id="title" ref = {(input)=> this.getTitle = input}>
                    ...
                    <div className = 'col-sm-5'>
                        <div className="form-group row">
                            ...
                            <div className="col-md-10">
                                <input required type="text" className="form-control validate setuppercase" id="firstname" pattern="[a-zA-Z]{1,}" title="Name contains Alphabets only" ref = {(input)=> this.getFirstName = input} />
                    ...
                    <div className = 'col-sm-5'>
                        <div className="form-group row">
                            ...
                            <div className="col-md-10">
                                <input required type="text" className="form-control validate setuppercase" id="lastname" pattern="[a-zA-Z]{1,}" title="Name contains Alphabets only" ref = {(input)=> this.getLastName = input} />
                ...
                <div className='row' id = 'row2'>
                    <div className = 'col-md-4'>
                        <div className="form-group row">
                            ...
                            <div className="col-9">
                                <Form.Control className = 'validate' required type="date" name="dob" placeholder="Date of Birth" max={new Date()} ref = {(input)=> this.getBirthday = input} />
                    ...
                    <div className = 'col-md-8'>
                        <div className="form-group row">
                            ...
                            <div className = 'col-10 class="input-field"'>
                                <select className = 'form-control' name="nationality" ref = {(input)=> this.getNationality = input}>
                ...
                <div className='row' id = 'row3'>
                   <div className = 'col-md-10'>
                        <div className="form-group row">
                            ...
                            <div className="col-md-10">
                                <input type="number" className="form-control" id="citizenid" pattern="[0-9]{13,13}" onChange={this.CheckLength} ref = {(input)=> this.getCitizenID = input} />
                            </div>
                        </div>
                    </div>  
                </div>
                ...
                <div className='row' id = 'row6'>
                    <div className = 'col-md-10'>
                        <div className="form-group row">
                            ...
                            <div className="col-4">
                                <input type="text" className="form-control setuppercase" id="passport" maxLength = {13} ref = {(input)=> this.getPassportNo = input}/>
                            </div>
                        </div>
                    </div> 
                </div>
                    ...
                    <div className = 'col-md-10'>
                        <div className="form-group row">
                            ...
                            <div className="input-field col-4">
                                <input required id="expectedsalary" type="number" className="validate" ref = {(input)=> this.getExpectedSalary = input}/>
                                <label className='font-style' style={{paddingLeft:'20px'}} for="expectedsalary">Thai Bath</label>
                            </div>
                        </div>
                    </div>
                    <div className = 'col-md-2'>
                        <button class="waves-effect waves-light btn-large submit-style" type="submit" name="action"> SUBMIT 
                        <i class="fa fa-send" style={{fontSize:'90%'}}> </i>
                        </button>
                    </div>
                </div>
            </div>
...
export default connect()(InformationForm);